(() => {
  ...
  const ASSETS={
    ...
    socialProof:{Mulher:"/assets/prova-social-mulher.jpeg",Homem:"/assets/prova-social-homem.jpeg"},
  ...
  function renderOffer(){
    ...
    app.innerHTML=`<main class="offer-page">
      ...
      <section class="what-you-get-section"><div class="offer-container offer-narrow"><p class="eyebrow">SEU PLANO COMPLETO</p><h2>Veja tudo que você recebe no Carnívora 40+</h2><p class="section-intro">Tudo organizado para você saber o que fazer sem precisar montar o plano sozinho.</p><ul class="receive-list">
        <li><span class="receive-emoji" aria-hidden="true">🥩</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Plano alimentar personalizado</strong><p>Uma estrutura de refeições montada a partir das respostas do seu quiz.</p></div></li>
        <li><span class="receive-emoji" aria-hidden="true">🍳</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Receitas e ideias de refeições</strong><p>Opções práticas para variar o preparo sem ficar sem saber o que comer.</p></div></li>
        <li><span class="receive-emoji" aria-hidden="true">🛒</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Lista prática de compras</strong><p>Uma referência simples para organizar os alimentos da sua rotina.</p></div></li>
        <li><span class="receive-emoji" aria-hidden="true">🔄</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Opções de substituição</strong><p>Alternativas para adaptar o plano às suas preferências e restrições informadas.</p></div></li>
        <li><span class="receive-emoji" aria-hidden="true">📋</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Orientações práticas para seguir</strong><p>Um passo a passo claro para colocar o plano em prática no dia a dia.</p></div></li>
        <li><span class="receive-emoji" aria-hidden="true">📱</span><span class="receive-check" aria-hidden="true">✓</span><div><strong>Acesso digital pelo celular</strong><p>Consulte seu plano quando precisar, de forma simples e direta.</p></div></li>
      </ul></div></section>
      <section class="personalized-solutions-section"><div class="offer-container offer-narrow"><p class="eyebrow">FEITO COM BASE NAS SUAS RESPOSTAS</p><h3 class="included-title">O seu plano foi preparado para estas prioridades:</h3><p class="personalized-intro">Selecionamos os pontos mais importantes com base nas respostas que você acabou de fornecer.</p><ul class="inclusion-list personalized-list">${priorities.map(x=>`<li><span>✓</span><div><small>DOR IDENTIFICADA</small><strong>${esc(x.pain)}</strong><p>${esc(x.solution)}</p></div></li>`).join("")}</ul>${timer()}${buyBox()}</div></section>
      <section class="visual-section social-proof-section"><div class="offer-container offer-narrow"><p class="eyebrow">EXPERIÊNCIA EM DESTAQUE</p><h2>Veja uma história que inspira</h2><div class="social-proof-image">${asset("socialProof","Depoimento em destaque")}</div><p class="social-proof-note">Resultados podem variar de pessoa para pessoa.</p>${timer()}${buyBox()}</div></section>
